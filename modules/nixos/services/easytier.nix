# Easytier VPN — the consumer of easytier-* secrets
# The easytier-env template is generated here using the current host's hostname
# to select the correct easytier-ipv4-<hostname> key from sops.
{ flake, config, lib, ... }:
let
